...
const Volunteer: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      axios.post('http://localhost:8080/api/volunteer', formData);
      setSubmitted(true);
    } catch (err: any) {
          ...
          <div className="volunteer-form-section">
            ...
            {submitted ? (
              <div style={{ textAlign: 'center', padding: '40px 0' }}>
                ...
                <button className="page-btn-primary" onClick={() => { setSubmitted(false); setFormData({ name: '', email: '', phone: '', role: '', eventId: '', availability: ''}); }}>
              ...
              <div className="registration-form" style={{ maxWidth: '100%' }}>
                  ...
                  <div className="form-row">
                    ...
                    <div className="form-group">
                      ...
                      <input type='text' name='event' value={formData.event} onChange={handleInputChange} placeholder={t('Type event name ', 'Tapez le nom de l\'événement ou sélectionnez dans la liste...')} />
                    </div>
                  </div>
                  ...
                  <div className="form-group">
                    ...
                    <textarea name="message" value={formData.reason} onChange={handleInputChange} placeholder={t('Share your motivation...', 'Partagez votre motivation...')} />
                  </div>
                  <div className="form-group">
                    <label>{t('Name the event of choice', 'Nommez l\'événement de votre choix')}</label>
                    <textarea name="event" value={formData.event} onChange={handleInputChange} placeholder={t('Enter the event name...', 'Entrez le nom de l\'événement...')} />
                  </div>
